export const codigosBancos = `2080 Abanca Corporación Bancaria
...
interface CodigoIban {
	codigoPais: string;
	digitoControlA: string;
	codigoBanco: string;
	codigoSucursal: string;
	digitoControlB: string;
	numeroCuenta: string;
}

export const ibanObject: CodigoIban = {
	codigoPais: "",
	digitoControlA: "",
	codigoBanco: "",
	codigoSucursal: "",
